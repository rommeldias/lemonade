...
import juicer.scikit_learn.cv_operation as cv
...
class ScikitLearnTranspiler(Transpiler):
    ...
    def _assign_operations(self):
        ...
        data_ops = {
            ...
            'read-image-folder': cv.ReadImageFolderOperation,
            'extract-faces': cv.ExtractFacesOperation,
            'extract-face-features': cv.ExtractFaceFeaturesOperation,
            'chinese-whispers-clustering': cv.ChineseWhispersOperation,
            'image-view': cv.ImageViewOperation,
